...
var ChartRadar = function (_React$Component) {
  _inherits(ChartRadar, _React$Component);

  function ChartRadar(props) {
    _classCallCheck(this, ChartRadar);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChartRadar).call(this, props));
  ...
  _createClass(ChartRadar, [{
    ...
    value: function componentDidMount() {
      ...
      this.state.chr = new Chart(ctx, { type: 'radar', data: ChartData, options: GlobalOptions });
    }
  }, {
...
module.exports = { ChartRadar: ChartRadar };
